package com.example.news.aggregation.web.handler;
...
import com.example.news.aggregation.web.vo.Result;
...
import static com.example.news.aggregation.base.response.ResponseCode.SYSTEM_ERROR;
/**
 * @author Hollis
 */
@ControllerAdvice
